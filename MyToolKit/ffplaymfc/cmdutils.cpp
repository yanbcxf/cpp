...
static void expand_filename_template(AVBPrint *bp, const char *template1, struct tm *tm)
{
    int c;
...
double get_rotation(AVStream *st)
{
    ...
    if (fabs(theta - 90*(int)(theta/90 + 0.5f)/*round(theta/90)*/) > 2)
