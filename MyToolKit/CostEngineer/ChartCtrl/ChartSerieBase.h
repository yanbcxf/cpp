...
public:
	...
	**/
	...
	/* yangbin 2016-9-18 ,寻找附近有“气球提示”的点位 */
	int SearchPointWithCustomLabel(unsigned uPointIndex);

	/* yangbin : 获取x 轴上某段曲线的 Y 轴最大最小值 */
	bool GetYMinMaxForXMinMax(double xMin, double xMax, double& yMin, double& yMax);
