...
#define FF_STREAM_SPEED_EVENT    (SDL_USEREVENT + 6)
...
typedef struct VideoState {
	...
	struct VideoState *next;			//	修改为双向链表
	struct VideoState *prev;
} VideoState;
...
extern int SaveAsJPEG(AVFrame* pFrame, int width, int height, int iIndex);
