#ifndef __GWINTERFACE_DEF_H_
#define __GWINTERFACE_DEF_H_
...
enum SIPD_PTZ_MOVE_OPER {SIPD_PTZ_MOVE_UP = 0, SIPD_PTZ_MOVE_DOWN = 1, SIPD_PTZ_MOVE_LEFT = 2, SIPD_PTZ_MOVE_RIGHT = 3, 
SIPD_PTZ_MOVE_LU = 4, SIPD_PTZ_MOVE_LD = 5, SIPD_PTZ_MOVE_RU = 6, SIPD_PTZ_MOVE_RD = 7, SIPD_PTZ_MOVE_STOP = 8, SIPD_PTZ_ZOOMTELE = 9,
SIPD_PTZ_ZOOMWIDE = 10, SIPD_PTZ_FOCUS_NEAR = 11, SIPD_PTZ_FOCUS_FAR = 12, SIPD_PTZ_HALLO_SMALL = 13, SIPD_PTZ_HALLO_LARGE = 14};
