...
class CCsiCsrcPeDaily : public CStockDataModel
{
public:
	CCsiCsrcPeDaily(void);
	~CCsiCsrcPeDaily(void);

	string ModelType(){ return  "CCsiCsrcPeDaily" /*""*/; }
