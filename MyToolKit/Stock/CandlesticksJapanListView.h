...
class CCandlesticksJapanListView : public CBaseGridCtlView
{
	DECLARE_DYNCREATE(CCandlesticksJapanListView)

protected:
public:
	CCandlesticksJapanListView();           // 动态创建所使用的受保护的构造函数
	virtual ~CCandlesticksJapanListView();
