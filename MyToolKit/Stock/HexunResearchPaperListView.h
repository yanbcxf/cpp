...
class CHexunResearchPaperListView : public CBaseGridCtlView
{
	DECLARE_DYNCREATE(CHexunResearchPaperListView)

protected:
public:
	CHexunResearchPaperListView();           // 动态创建所使用的受保护的构造函数
	virtual ~CHexunResearchPaperListView();
