...
class CSimulatedAccountListView : public CBaseGridCtlView
{
	DECLARE_DYNCREATE(CSimulatedAccountListView)

protected:
public:
	CSimulatedAccountListView();           // 动态创建所使用的受保护的构造函数
	virtual ~CSimulatedAccountListView();
