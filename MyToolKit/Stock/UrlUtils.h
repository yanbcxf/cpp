...
public:
	...
	static string PostUrlOfCfi(string url, char*  data);

	static int PostUrlOfCsindex(string url, unsigned char* & pdata);

	static int PostUrlOfSzse(string url, unsigned char* & pdata);

	static string PostUrlOfCffex(string url,char* data);

	static int PostUrlOfCninfo(string url, unsigned char* & pdata);
