...
template< typename stored_type, typename tree_type, typename container_type >
typename tcl::associative_tree<stored_type, tree_type, container_type>::size_type 
...
// operator ==
template<typename stored_type, typename tree_type, typename container_type>
bool tcl::associative_tree<stored_type, tree_type, container_type>::operator == (const associative_tree_type& rhs) const
{
	// check this node
	if ((*basic_tree_type::get() < *rhs.get()) || (*rhs.get() < *basic_tree_type::get()))
		return false;
