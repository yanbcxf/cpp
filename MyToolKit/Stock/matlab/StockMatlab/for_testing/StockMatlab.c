 ...
 * Date: Mon Dec 04 11:12:24 2017
 * Arguments: "-B" "macro_default" "-W" "lib:StockMatlab" "-T" "link:lib" "-d"
 * "D:\workspace_c3\MyToolKit\Stock\matlab\StockMatlab\for_testing" "-v"
...
LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStCloseWindow(int nargout, mxArray** handleNumber, mxArray* 
                                   windowNumber)
{
  return mclMlfFeval(_mcr_inst, "StCloseWindow", nargout, 1, 1, handleNumber, windowNumber);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStHuShenIndex(int nargout, mxArray** handleNumber, mxArray* 
                                   windowNumber, mxArray* startDate, mxArray* endDate, 
                                   mxArray* indexCode)
{
  return mclMlfFeval(_mcr_inst, "StHuShenIndex", nargout, 1, 4, handleNumber, windowNumber, startDate, endDate, indexCode);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStocktest(mxArray* wndname, mxArray* surface)
{
  return mclMlfFeval(_mcr_inst, "stocktest", 0, 0, 2, wndname, surface);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStOpenWindow(mxArray* windowNumber)
{
  return mclMlfFeval(_mcr_inst, "StOpenWindow", 0, 0, 1, windowNumber);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStShanghaiIndex(int nargout, mxArray** handleNumber, mxArray* 
                                     windowNumber, mxArray* startDate, mxArray* endDate)
{
  return mclMlfFeval(_mcr_inst, "StShanghaiIndex", nargout, 1, 3, handleNumber, windowNumber, startDate, endDate);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStShanghaiIndiStockIndex(int nargout, mxArray** handleNumber, 
                                              mxArray* windowNumber, mxArray* startDate, 
                                              mxArray* endDate, mxArray* stockCode)
{
  return mclMlfFeval(_mcr_inst, "StShanghaiIndiStockIndex", nargout, 1, 4, handleNumber, windowNumber, startDate, endDate, stockCode);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStShanghaiSohuPlateIndex(int nargout, mxArray** handleNumber, 
                                              mxArray* windowNumber, mxArray* startDate, 
                                              mxArray* endDate, mxArray* graphOrTable, 
                                              mxArray* plateCodes)
{
  return mclMlfFeval(_mcr_inst, "StShanghaiSohuPlateIndex", nargout, 1, 5, handleNumber, windowNumber, startDate, endDate, graphOrTable, plateCodes);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStShanghaiStockIndex(int nargout, mxArray** handleNumber, mxArray* 
                                          windowNumber, mxArray* startDate, mxArray* 
                                          endDate, mxArray* graphOrTable, mxArray* 
                                          stockCodes)
{
  return mclMlfFeval(_mcr_inst, "StShanghaiStockIndex", nargout, 1, 5, handleNumber, windowNumber, startDate, endDate, graphOrTable, stockCodes);
}

LIB_StockMatlab_C_API 
bool MW_CALL_CONV mlfStShenzhenIndexPlateIndex(int nargout, mxArray** handleNumber, 
                                               mxArray* windowNumber, mxArray* startDate, 
                                               mxArray* endDate, mxArray* graphOrTable, 
                                               mxArray* plateCodes)
{
  return mclMlfFeval(_mcr_inst, "StShenzhenIndexPlateIndex", nargout, 1, 5, handleNumber, windowNumber, startDate, endDate, graphOrTable, plateCodes);
}
