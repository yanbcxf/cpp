#include "StdAfx.h"
#include "CalcCsdcTransferBonusStatDownload.h"

CCalcCsdcTransferBonusStatDownload::CCalcCsdcTransferBonusStatDownload(HWND hwnd, int logType)
:CCalculateTask(hwnd, logType)
{
}

CCalcCsdcTransferBonusStatDownload::~CCalcCsdcTransferBonusStatDownload(void)
{
}
...
void CCalcCsdcTransferBonusStatDownload::NeedDownload1(void* firstArg)
{
	CCalcCsdcTransferBonusStatDownload * sink = (CCalcCsdcTransferBonusStatDownload *)firstArg;
	sink->NeedDownload();
}



void CCalcCsdcTransferBonusStatDownload::NeedDownload()
{
