...
class CCninfoIncentivePlanListView : public CBaseGridCtlView
{
	DECLARE_DYNCREATE(CCninfoIncentivePlanListView)

protected:
public:
	CCninfoIncentivePlanListView();           // 动态创建所使用的受保护的构造函数
	virtual ~CCninfoIncentivePlanListView();
