...
CCalcCsdcInvestorStatDownload::CCalcCsdcInvestorStatDownload(HWND hwnd, int logType)
:CCalculateTask(hwnd, logType)
{
}

CCalcCsdcInvestorStatDownload::~CCalcCsdcInvestorStatDownload(void)
{
}
...
void CCalcCsdcInvestorStatDownload::NeedDownload1(void* firstArg)
{
	CCalcCsdcInvestorStatDownload * sink = (CCalcCsdcInvestorStatDownload *)firstArg;
	sink->NeedDownload();
}



void CCalcCsdcInvestorStatDownload::NeedDownload()
{
