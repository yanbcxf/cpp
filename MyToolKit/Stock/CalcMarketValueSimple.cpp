...
CCalcMarketValueSimple::CCalcMarketValueSimple(HWND hwnd, int logType)
:CCalculateTask(hwnd, logType)
{
}

CCalcMarketValueSimple::~CCalcMarketValueSimple(void)
{
}
...
void CCalcMarketValueSimple::Execute1(void* firstArg)
{
	CCalcMarketValueSimple * sink = (CCalcMarketValueSimple *)firstArg;
	sink->Execute();
}



void CCalcMarketValueSimple::Execute()
{
	/*汇总需要下载财务报表的股票*/
