 ...
 */
static  void __list_add(struct list_head *newptr,
 ...
 */
static void list_add(struct list_head *newptr, struct list_head *head)
{
 ...
 */
static void list_add_tail(struct list_head *newptr, struct list_head *head)
{
...
/**
 * list_for_each_safe_reverse	-	iterate backwards over a list safe against removal of list entry
 * @pos:	the &struct list_head to use as a loop counter.
 * @n:		another &struct list_head to use as temporary storage
 * @head:	the head for your list.
 */
