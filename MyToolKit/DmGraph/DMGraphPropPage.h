...
BEGIN_MSG_MAP(CDMGraphPropPage)
	...
	COMMAND_HANDLER(IDC_X_GRID_STEP, EN_CHANGE, OnChanged_grid_stepX)
	COMMAND_HANDLER(IDC_Y_GRID_STEP, EN_CHANGE, OnChanged_grid_stepY)
...
protected:
	...
	LRESULT OnChanged_grid_stepX(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnChanged_grid_stepY(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
