...
#define GVL_XLSTYLE_SCROLL		0x4L	// Excel style scrolling
...
#define GVN_LAST				GVN_ODCACHEHINT
...
protected:
	...
	CTypedPtrArray<CObArray, GRID_ROW*> *m_pRowData;
