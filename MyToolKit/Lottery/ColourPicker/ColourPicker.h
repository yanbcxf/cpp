...
protected:
    ...
    //}}AFX_MSG
    afx_msg /*LONG*/LRESULT OnSelEndOK(/*UINT*/WPARAM lParam, /*LONG*/LPARAM wParam);
    afx_msg /*LONG*/LRESULT OnSelEndCancel(/*UINT*/WPARAM lParam, /*LONG*/LPARAM wParam);
    afx_msg /*LONG*/LRESULT OnSelChange(/*UINT*/WPARAM lParam, /*LONG*/LPARAM wParam);
