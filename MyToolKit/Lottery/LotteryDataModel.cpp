...
CLotteryDataModel::CLotteryDataModel(void)
{
	m_nCode = -1;
	m_nRowNum = 0;
	m_hWnd = NULL;
...
void CLotteryDataModel::NotifyDatabaseImportedToWindow()
{
	/*stringstream ss;
...
long  CLotteryDataModel::CheckDownloadFileInfo(string middleFileName)
{
	stringstream ss;
	long	nfilesize = 0;
...
long  CLotteryDataModel::GetDownloadFileSize(string middleFileName)
{
	stringstream ss;
	long	nfilesize = 0;
