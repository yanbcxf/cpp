...
void CChartCandlestickSerie::DrawCandleStick(CDC* pDC, SChartCandlestickPoint Point,  int nUpOrDown)
{
	int ScreenXVal = m_pHorizontalAxis->ValueToScreen(Point.XVal);
	...
	if(nUpOrDown>0 && Point.Open > Point.Close)
		return;
