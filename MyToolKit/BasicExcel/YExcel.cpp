...
int main(int argc, char* argv[])
{
	...
	e.Load("csi20160708.xls"  /*"rzrq_detail.xls"*/);	
	BasicExcelWorksheet* sheet1 = e.GetWorksheet(/*L"融资融券交易明细"*/ L"个股数据");
	if (sheet1)
	{
		size_t maxRows = sheet1->GetTotalRows();
		size_t maxCols = sheet1->GetTotalCols();
		cout << "Dimension of " << sheet1->GetUnicodeSheetName() << " (" << maxRows << ", " << maxCols << ")" << endl;
	...
	e.Load("IncomeStatement(300039)_.xls");	
