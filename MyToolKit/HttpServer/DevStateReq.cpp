#include "StdAfx.h"
#include "DevStateReq.h"


//	≈‰÷√–≈œ¢«Î«Û
CDevStateReq::CDevStateReq(CHttpSvr * pHttpSvr)
:CHttpHandle(pHttpSvr, HTTP_HANDLE_CONTENT, "DevStateReq")
{
}

CDevStateReq::~CDevStateReq(void)
{
}

bool CDevStateReq::Handle(CHttpRequest & Request)
{
...
void CDevStateReq::SendJsonTree(CHttpRequest & Request)
{
