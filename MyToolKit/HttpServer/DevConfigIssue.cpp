#include "StdAfx.h"
#include "DevConfigIssue.h"


//	≈‰÷√–≈œ¢«Î«Û
CDevConfigIssue::CDevConfigIssue(CHttpSvr * pHttpSvr)
:CHttpHandle(pHttpSvr, HTTP_HANDLE_CONTENT, "DevConfigIssue")
{
}

CDevConfigIssue::~CDevConfigIssue(void)
{
}

bool CDevConfigIssue::Handle(CHttpRequest & Request)
{
...
void CDevConfigIssue::SendJsonTree(CHttpRequest & Request)
{
