#include "StdAfx.h"
#include "DevConfigReq.h"


//	≈‰÷√–≈œ¢«Î«Û
CDevConfigReq::CDevConfigReq(CHttpSvr * pHttpSvr)
:CHttpHandle(pHttpSvr, HTTP_HANDLE_CONTENT, "DevConfigReq")
{
}

CDevConfigReq::~CDevConfigReq(void)
{
}

bool CDevConfigReq::Handle(CHttpRequest & Request)
{
...
void CDevConfigReq::SendJsonTree(CHttpRequest & Request)
{
